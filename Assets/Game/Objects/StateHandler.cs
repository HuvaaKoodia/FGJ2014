...
public class StateHandler : MonoBehaviour
{
    ...
    public AudioClip attack, death, rejected, accepted;
    ...
    public void playSFX (string sampleName)
    {
        ...
        if (sampleName == "rejected" && !audio_src.isPlaying) {
            
            audio_src.PlayOneShot (rejected);
        }
        if (sampleName == "accepted" && !audio_src.isPlaying) {
            
            audio_src.PlayOneShot (accepted);
        }
